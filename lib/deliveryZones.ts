export const DELIVERY_ZONES: Record<string, string[]> = {
  ...
  "Maramureș": ["Baia Mare", "Ulmeni", "Șomcuta Mare", "Borșa", "Moisei", "Seini", "Vișeu de Sus", "Valea Izei", "Sighetu Marmației", "Ocna Șugatag", "Cavnic", "Târgu Lăpuș", "Copalnic-Mănăștur"],
